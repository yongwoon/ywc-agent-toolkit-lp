...
| [`ywc-debug-rootcause`](#버그의-원인을-못-찾아서-답답하다) | 버그의 원인을 못 찾아서 답답하다 |
| [`ywc-refactor-clean`](#오래된-dead-code-미사용-함수export의존성를-정리하고-싶다) | 오래된 dead code (미사용 함수/export/의존성)를 정리하고 싶다 |
| [`ywc-incident-postmortem`](#production-장애가-나서-회고-문서를-써야-한다) | Production 장애가 나서 회고 문서를 써야 한다 |
...
[← 이전: 12. Executor / Code-gen Prompt 패턴](./12-executor-and-codegen-patterns.md) · [다음: 14. 사전 준비와 설치 →](./14-prerequisites-installation.md)
