...
| Skill | 설명 | 위치 |
|---|---|---|
| `ywc-agent-legibility-audit` | Agent 가 코드를 고칠 때 드는 token 비용과 가독성을 측정하고 싶다 | [여기](#agent-가-코드를-고칠-때-드는-token-비용과-가독성을-측정하고-싶다) |
...
| `ywc-impl-review` | 일반 cycle 밖에서 독립적으로 구현 품질과 maintenance 관점을 점검하고 싶다 | [여기](#일반-cycle-밖에서-독립적으로-구현-품질과-maintenance-관점을-점검하고-싶다) |
| `ywc-improve-architecture` | 뒤엉킨 shallow module 구조를 deep module 로 재구조화하고 싶다 | [여기](#뒤엉킨-shallow-module-구조를-deep-module-로-재구조화하고-싶다) |
...
| `ywc-refactor-clean` | 오래된 dead code (미사용 함수/export/의존성)를 정리하고 싶다 | [여기](#오래된-dead-code-미사용-함수export의존성를-정리하고-싶다) |
