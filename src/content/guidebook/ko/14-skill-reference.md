...
| `ywc-code-gen` | Backend/Frontend/QA 3개 layer 를 병렬로 동시 생성하는 다층 code 생성 skill | [14](./13-executor-and-codegen-patterns.md) |
...
| `ywc-parallel-executor` | 여러 Task 를 격리된 worktree 에서 병렬로 실행하는 executor | [14](./13-executor-and-codegen-patterns.md) |
...
| `ywc-sequential-executor` | 여러 Task 를 순서대로 하나씩 실행하는 executor | [14](./13-executor-and-codegen-patterns.md) |
...
[← 이전: 14. Executor / Code-gen Prompt 패턴](./13-executor-and-codegen-patterns.md) · [다음: 16. 사전 준비와 설치 →](./15-prerequisites-installation.md)
