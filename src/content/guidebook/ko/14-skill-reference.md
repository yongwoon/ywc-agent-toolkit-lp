...
`ywc-refactor-clean` 전용 페이지로 옮겼습니다 — 자세한 사용법과 예시는 [16. 코드 구조와 유지보수성 관리](./16-code-structure-and-maintainability.md)를 참고하세요.

### 뒤엉킨 shallow module 구조를 deep module 로 재구조화하고 싶다

`ywc-improve-architecture` 전용 페이지로 옮겼습니다 — 자세한 사용법과 예시는 [16. 코드 구조와 유지보수성 관리](./16-code-structure-and-maintainability.md)를 참고하세요.

### 일반 cycle 밖에서 독립적으로 구현 품질과 maintenance 관점을 점검하고 싶다

`ywc-impl-review` 전용 페이지로 옮겼습니다 — 자세한 사용법과 예시는 [16. 코드 구조와 유지보수성 관리](./16-code-structure-and-maintainability.md)를 참고하세요.

### Agent 가 코드를 고칠 때 드는 token 비용과 가독성을 측정하고 싶다

`ywc-agent-legibility-audit` 전용 페이지로 옮겼습니다 — 자세한 사용법과 예시는 [16. 코드 구조와 유지보수성 관리](./16-code-structure-and-maintainability.md)를 참고하세요.
...
| Skill | 설명 | 위치 |
|---|---|---|
| `ywc-agent-legibility-audit` | Agent 가 코드를 고칠 때 드는 token 비용과 가독성을 측정하고 싶다 | [16](./16-code-structure-and-maintainability.md) |
...
| `ywc-code-gen` | Backend/Frontend/QA 3개 layer 를 병렬로 동시 생성하는 다층 code 생성 skill | [13](./13-executor-and-codegen-patterns.md) |
...
| `ywc-impl-review` | 일반 cycle 밖에서 독립적으로 구현 품질과 maintenance 관점을 점검하고 싶다 | [16](./16-code-structure-and-maintainability.md) |
| `ywc-improve-architecture` | 뒤엉킨 shallow module 구조를 deep module 로 재구조화하고 싶다 | [16](./16-code-structure-and-maintainability.md) |
...
| `ywc-parallel-executor` | 여러 Task 를 격리된 worktree 에서 병렬로 실행하는 executor | [13](./13-executor-and-codegen-patterns.md) |
...
| `ywc-refactor-clean` | 오래된 dead code (미사용 함수/export/의존성)를 정리하고 싶다 | [16](./16-code-structure-and-maintainability.md) |
...
| `ywc-sequential-executor` | 여러 Task 를 순서대로 하나씩 실행하는 executor | [13](./13-executor-and-codegen-patterns.md) |
