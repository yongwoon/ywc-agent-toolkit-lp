...
다만 Skill 을 실제로 실행할 때는 `git`, `gh`, `python3` 등 몇 가지 Tool 이 System 에 준비되어 있어야 하고, 디자인 관련 Skill 을 쓰려면 별도 설정이 도움이 됩니다. 필수 Tool 과 선택 Tool 목록, 설치 방법은 [14. 사전 준비와 설치](./14-prerequisites-installation.md)에 정리했습니다 — 시작하기 전에 한 번 훑어보는 것을 권장합니다.
