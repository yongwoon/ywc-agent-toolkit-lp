...
- If the idea is not concrete yet, unlike this exercise where the problem is already clear -> start with `ywc-brainstorm` (see [17. Full Skill Reference](./14-skill-reference.md))
