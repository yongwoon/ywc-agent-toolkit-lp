...
<ToolTabs>
  <ToolTabsPanel tool="claude-code" label="Claude Code">
    <CodeBlock label="claude code" code="ywc-plan Users need a settings screen and API to turn notification types on/off individually. Support email/push/in-app, 3 channels" />
  </ToolTabsPanel>
  <ToolTabsPanel tool="codex" label="Codex">
    <CodeBlock label="codex" code="ywc-plan Users need a settings screen and API to turn notification types on/off individually. Support email/push/in-app, 3 channels" />
  </ToolTabsPanel>
</ToolTabs>
...
The execution commands after this have many options, so they are covered on a separate page: [15. Executor / Code-gen Prompt patterns](./13-executor-and-codegen-patterns.md). The simplest starting point is:
