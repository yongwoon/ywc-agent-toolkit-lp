...
| Execute Tasks that are already decomposed (sequential/parallel) | `ywc-sequential-executor` / `ywc-parallel-executor` | [15](./13-executor-and-codegen-patterns.md) |
| Clarify an idea that is not concrete yet | `ywc-brainstorm` | [16](./14-skill-reference.md) |
...
| Check code for security vulnerabilities | `ywc-security-audit` | [16](./14-skill-reference.md) |
...
| Respond to review comments on an open PR | `ywc-handle-pr-reviews` | [16](./14-skill-reference.md) |
| Clean up a backlog of Dependabot PRs at once | `ywc-merge-dependabot` | [16](./14-skill-reference.md) |
| Write a CHANGELOG or release note | `ywc-changelog-release-notes` | [16](./14-skill-reference.md) |
| Just commit the work done so far | `ywc-commit` | [16](./14-skill-reference.md) |
...
| Compare libraries or implementation approaches to decide what to use | `ywc-tech-research` | [16](./14-skill-reference.md) |
| Manage knowledge (glossary/review learnings/mission) that persists in the project after the conversation ends | `ywc-ubiquitous-language` | [16](./14-skill-reference.md) |

For situations not covered in this table, see [16. Full Skill Reference](./14-skill-reference.md).
...
| Page | Description |
|---|---|
| [15. Executor / Code-gen Prompt patterns](./13-executor-and-codegen-patterns.md) | Practical command examples for option-heavy `ywc-sequential-executor` / `ywc-parallel-executor` / `ywc-code-gen` |
| [16. Full Skill Reference](./14-skill-reference.md) | An index of the remaining Skills not covered in the guides above, organized by situation |
| [17. Prerequisites and installation](./15-prerequisites-installation.md) | The required and optional tools you need in place before ywc-* Skills run reliably |
