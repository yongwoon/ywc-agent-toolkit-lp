...
| Ejecute Tasks que ya están descompuestos (secuencial/paralelo) | `ywc-sequential-executor` / `ywc-parallel-executor` | [12](./12-executor-and-codegen-patterns.md) |
| Aclara una idea que aún no es concreta | `ywc-brainstorm` | [13](./13-skill-reference.md) |
...
| Verificar el código en busca de vulnerabilidades de seguridad | `ywc-security-audit` | [13](./13-skill-reference.md) |
| Estás atascado porque no puedes encontrar la causa raíz de un error | `ywc-debug-rootcause` | [13](./13-skill-reference.md) |
| Ocurrió un incidente de producción y necesitas escribir un informe posterior al incidente | `ywc-incident-postmortem` | [13](./13-skill-reference.md) |
| Limpia el código antiguo muerto | `ywc-refactor-clean` | [13](./13-skill-reference.md) |
| Responder a los comentarios de revisión en un PR abierto | `ywc-handle-pr-reviews` | [13](./13-skill-reference.md) |
| Limpiar de una vez un acumulado de PRs de Dependabot | `ywc-merge-dependabot` | [13](./13-skill-reference.md) |
| Escribe una CHANGELOG o nota de lanzamiento | `ywc-changelog-release-notes` | [13](./13-skill-reference.md) |
| Simplemente confirma el trabajo realizado hasta ahora | `ywc-commit` | [13](./13-skill-reference.md) |

Para situaciones no cubiertas en esta tabla, consulte [13. Full Skill Reference](./13-skill-reference.md).
...
| Página | Descripción |
|---|---|
| [12. Executor / Code-gen Prompt patterns](./12-executor-and-codegen-patterns.md) | Ejemplos prácticos de comandos para `ywc-sequential-executor` / `ywc-parallel-executor` / `ywc-code-gen` con muchas opciones |
| [13. Full Skill Reference](./13-skill-reference.md) | Un índice de las Habilidades restantes no cubiertas en las guías anteriores, organizado por situación |
