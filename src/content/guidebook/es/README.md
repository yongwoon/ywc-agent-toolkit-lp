...
| Ejecute Tasks que ya están descompuestos (secuencial/paralelo) | `ywc-sequential-executor` / `ywc-parallel-executor` | [15](./13-executor-and-codegen-patterns.md) |
| Aclara una idea que aún no es concreta | `ywc-brainstorm` | [16](./14-skill-reference.md) |
...
| Verificar el código en busca de vulnerabilidades de seguridad | `ywc-security-audit` | [16](./14-skill-reference.md) |
...
| Responder a los comentarios de revisión en un PR abierto | `ywc-handle-pr-reviews` | [16](./14-skill-reference.md) |
| Limpiar de una vez un acumulado de PRs de Dependabot | `ywc-merge-dependabot` | [16](./14-skill-reference.md) |
| Escribe una CHANGELOG o nota de lanzamiento | `ywc-changelog-release-notes` | [16](./14-skill-reference.md) |
| Simplemente confirma el trabajo realizado hasta ahora | `ywc-commit` | [16](./14-skill-reference.md) |
...
| Quieres comparar librerías o enfoques de implementación para decidir qué usar | `ywc-tech-research` | [16](./14-skill-reference.md) |
| Gestionar el conocimiento (glosario/aprendizajes de revisión/mission) que permanece en el proyecto después de que termina la conversación | `ywc-ubiquitous-language` | [16](./14-skill-reference.md) |

Para situaciones no cubiertas en esta tabla, consulte [16. Full Skill Reference](./14-skill-reference.md).
...
| Página | Descripción |
|---|---|
| [15. Executor / Code-gen Prompt patterns](./13-executor-and-codegen-patterns.md) | Ejemplos prácticos de comandos para `ywc-sequential-executor` / `ywc-parallel-executor` / `ywc-code-gen` con muchas opciones |
| [16. Full Skill Reference](./14-skill-reference.md) | Un índice de las Habilidades restantes no cubiertas en las guías anteriores, organizado por situación |
| [17. Requisitos previos e instalación](./15-prerequisites-installation.md) | La lista de herramientas obligatorias y opcionales que debes tener listas para que las Skills ywc-* funcionen de forma fiable |
