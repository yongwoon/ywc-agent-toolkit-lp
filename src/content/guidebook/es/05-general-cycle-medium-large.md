...
Los comandos de ejecución después de esto tienen muchas opciones, por lo que se cubren en una página separada: [12. Executor / Code-gen Prompt patterns](./12-executor-and-codegen-patterns.md). El punto de partida más simple es:
