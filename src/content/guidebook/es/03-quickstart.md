...
- Si la idea aún no es concreta, a diferencia de este ejercicio donde el problema ya está claro -> comienza con `ywc-brainstorm` (ver [16. Full Skill Reference](./14-skill-reference.md))
